...
# === YOUR API KEYS (set these in Render Environment Variables) ===
...
def chat():
    ...
    system_prompt = f"You are {character} from Shadows of Seduction. Respond naturally as the character. Never use asterisks or action descriptions."
...
def voice():
    ...
    print(f"🔊 Voice request for {character} - text length: {len(text)}")
