...
def chat():
    ...
    system_prompt = f"You are {character} from Shadows of Seduction. Respond naturally and conversationally."
...
def voice():
    ...
    print(f"🔊 Voice request - Character: {character}, Text length: {len(text)} chars")
    print(f"ElevenLabs API Key present: {'Yes' if ELEVENLABS_API_KEY else 'NO - MISSING!'}")
